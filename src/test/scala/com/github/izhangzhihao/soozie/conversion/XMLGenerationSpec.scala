...
class XMLGenerationSpec extends Specification {
  "XML Generation" should {
    "be able to successfully generate a bundle" in {
      ...
      val expectedResult =
        """<bundle-app name="APPNAME" xmlns="uri:oozie:bundle:0.2">
          |    <parameters>
          |        <property>
          |            <name>appPath</name>
          |        </property>
    ...
    "be able to successfully generate a coordinator" in {
      ...
      val expectedResult =
        """<coordinator-app timezone="America/Los_Angeles" end="2009-01-04T08:00Z" start="2009-01-02T08:00Z" frequency="${coord:days(1)}" name="hello-coord" xmlns="uri:oozie:coordinator:0.4">
          |    <controls>
          |        <timeout>10</timeout>
